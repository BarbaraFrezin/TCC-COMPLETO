...
$codigo = $nomeCliente = $codPessoa = $data = $horario = $procedimento = '';
    ...
    <div class="container">
        <div class="row">
            ...
            <form action="agendamento.php" method="POST" class="form-inline">
                <div class="form-group">
                    <input type="text" name="nomeCliente" placeholder="NOME CLIENTE" class="form-control" style="margin-bottom: -2px; height: 25px;">
                    <input type="date" name="data" id="data" placeholder="Data..." class="form-control" style="margin-bottom: -2px; height: 25px;">
                    <input type="time" name="horario" id="horario" placeholder="Horario..." class="form-control" style="margin-bottom: -2px; height: 25px;"><br><br>
                </div><br>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    if (isset($_POST['pesquisar'])) {
                        ...
                        $consulta = "SELECT codigo, nomeCliente, codPessoa, data, horario, procedimento FROM agendamento ORDER BY data, horario";
                        $resultado = mysqli_query($con,$consulta);
                    }
