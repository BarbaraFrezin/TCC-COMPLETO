...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['cadastrar'])) {
        ...
        $sql_cadastrar = "INSERT INTO contaspagar (codigo, parcela, codPessoa, valor, status, vencimento, dataConta) VALUES ('$codigo', '$parcela', '$codPessoa', '$valor', '$status', '$vencimento', '$dataConta')";
        $res_cadastrar = mysqli_query($con,$sql_cadastrar);

        if ($res_cadastrar) {
            echo '<script>alert("Registro cadastrado com sucesso!");</script>';
            echo '<script>window.location="contaspagar.php";</script>';
        } else {
    ...
    if (isset($_POST['alterar'])) {
        ...
        $sql_alterar = "UPDATE contaspagar SET parcela='$parcela', codPessoa='$codPessoa', valor='$valor', status='$status', vencimento='$vencimento', dataConta='$dataConta' WHERE codigo='$codigo'";
    ...
    if (isset($_POST['excluir'])) {
        ...
        $sql_excluir = "DELETE FROM contaspagar WHERE codigo='$codigo'";
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-group well" action="contaspagar.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="parcela" class="form-control" required>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-group well" action="contaspagar.php" method="POST">
                        ...
                        <div class="form-group">
                            <label for="valor">Valor</label>
                            <input id="valor" type="number" name="valor" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="status">Status</label>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    if (isset($_POST['pesquisar'])) {
                        ...
                        $consulta = "SELECT codigo, parcela, codPessoa, valor, status, vencimento, dataConta FROM contaspagar WHERE UPPER(codigo) LIKE '%$codigo%'";
                        ...
                        $consulta = "SELECT codigo, parcela, codPessoa, valor, status, vencimento, dataConta FROM contaspagar";
                        $resultado = mysqli_query($con,$consulta);
                    }
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="movimentoPagar.php?codigoConta=<?php echo $dados['codigo']; ?>&valorConta=<?php echo $dados['valor'] / $dados['parcela']; ?>&redirected_from_contaspagar=true" class="btn btn-info btnMovimentar">
                                    Movimentar
                                </a>
