...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['cadastrar'])) {
        ...
        $sql_cadastrar = "INSERT INTO grupoprodutos (codigo, nome) VALUES ('$codigo', '$nome')";
        $res_cadastrar = mysqli_query($con,$sql_cadastrar);

        if ($res_cadastrar) {
            echo '<script>alert("Registro cadastrado com sucesso!");</script>';
            echo '<script>window.location="grupoprodutos.php";</script>';
        } else {
    ...
    if (isset($_POST['alterar'])) {
        ...
        $sql_alterar = "UPDATE grupoprodutos SET nome='$nome' WHERE codigo='$codigo'";
    ...
    if (isset($_POST['excluir'])) {
        ...
        $sql_excluir = "DELETE FROM grupoprodutos WHERE codigo='$codigo'";
...
<body>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h1>CADASTRAR GRUPO PRODUTOS</h1>
                </div>
                <div class="modal-body">
                    <!-- Modal com form para se fazer cadastro  -->
                    <form class="form-group well" action="grupoprodutos.php" method="POST">
    ...
    <div class="container">
        <div class="row">
            <h2 class="text-center">GRUPO PRODUTOS</h2>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    if (isset($_POST['pesquisar'])) {
                        ...
                        $consulta = "SELECT codigo, nome FROM grupoprodutos WHERE UPPER(codigo) LIKE '%$codigo%'";
                        ...
                        $consulta = "SELECT codigo, nome FROM grupoprodutos";
                        $resultado = mysqli_query($con,$consulta);
                    }
