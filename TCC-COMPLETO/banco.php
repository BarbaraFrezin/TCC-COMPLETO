...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['cadastrar'])) {
        ...
        $sql_cadastrar = "INSERT INTO banco (codigo, nome) VALUES ('$codigo', '$nome')";
        $res_cadastrar = mysqli_query($con,$sql_cadastrar);

        if ($res_cadastrar) {
            echo '<script>alert("Registro cadastrado com sucesso!");</script>';
            echo '<script>window.location="banco.php";</script>';
        } else {
    ...
    if (isset($_POST['alterar'])) {
        ...
        $sql_alterar = "UPDATE banco SET nome='$nome' WHERE codigo='$codigo'";
    ...
    if (isset($_POST['excluir'])) {
        ...
        $sql_excluir = "DELETE FROM banco WHERE codigo='$codigo'";
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-group well" action="banco.php" method="POST">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    if (isset($_POST['pesquisar'])) {
                        ...
                        $consulta = "SELECT codigo, nome FROM banco WHERE UPPER(codigo) LIKE '%$codigo%'";
                        ...
                        $consulta = "SELECT codigo, nome FROM banco";
                        $resultado = mysqli_query($con,$consulta);
                    }
