...
$sql_contasreceber = "SELECT codigo FROM contasreceber";
$res_contasreceber = mysqli_query($con,$sql_contasreceber);
...
if (isset($_GET['redirected_from_contasreceber']) && $_GET['redirected_from_contasreceber'] == 'true') {
    // A variável de sessão será usada para garantir que o popup seja exibido apenas uma vez
    $_SESSION['redirected_from_contasreceber'] = true;
}
?>
...
<head>
    ...
    <title>Movimento Contas a Receber</title>
...
<body>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h1>Realizar movimentação de conta a receber...</h1>
                </div>
                <div class="modal-body">
                    <!--- Modal com form para se fazer cadastro  -->
                    <form class="form-group well" action="movimentoReceber.php" method="POST">
                        ...
                        <select name="codigo" id="codigo"   class="span3" style=" margin-bottom: -2px; height: 25px;">
                                     ...
                                     <?php
                                        while($resultado = mysqli_fetch_array($res_contasreceber))
                                        {
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-group well" action="movimentoReceber.php" method="POST">
                        <input type="numeric" name="idmovimento" class="span3" value="" required placeholder="Codigo" style=" margin-bottom: -2px; height: 25px;">
                        <select name="codigoConta" id="codigo"   class="span3" style=" margin-bottom: -2px; height: 25px;">
                                     <option value=0 selected="selected">Código Conta</option>
                                     <?php
                                     $sql_contasreceber = "SELECT codigo FROM contasreceber";
                                     $res_contasreceber = mysqli_query($con,$sql_contasreceber);
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-group well" action="movimentoReceber.php" method="POST">
                        Codigo  <input id="idmovimento" type="text" name="idmovimento" value="" required><br><br>
    ...
    <div class="container">
        <div class="row">
            ...
            <h2 class="text-center">MOVIMENTO CONTAS A RECEBER</h2><br>
            <form action="movimentoReceber.php" method="POST">
                <input type="number" name="idmovimento" placeholder="CÓDIGO" class="span4" style="margin-bottom: -2px; height: 25px;">
                <input type="date" name="dataMovimento" class="span4" style="margin-bottom: -2px; height: 25px;"> <br><br>
            ...
            <table border="1px" bordercolor="gray" class="table table-stripped">
                ...
                <?php
                  ...
                  if (isset($_POST['cadastrar'])) {
                    ...
                    $sql = "insert into movimentoreceber (idmovimento, codigoConta, dataMovimento, parcela, valor, juros, total, codContaCorrente)
                            values ('$idmovimento','$codigoConta','$dataMovimento','$parcela','$valor','$juros','$total','$codContaCorrente')";
                    $resultado = mysqli_query($con,$sql);

                    $resultado = mysqli_query($con, $sql);
                    $atualizarSql = "UPDATE contasreceber SET valor = valor - '$total', parcela = parcela - '$parcela' WHERE codigo = '$codigoConta'";
                ...
                if (isset($_POST['alterar'])) {
                    ...
                    $consultaAntiga = mysqli_query($con, "SELECT * FROM movimentoreceber WHERE idmovimento = '$idmovimento'");
                    ...
                    try {
                        ...
                        $sqlReverterContareceber = "UPDATE contasreceber SET valor = valor + {$dadosAntigos['total']}, parcela = parcela + '{$dadosAntigos['parcela']}' WHERE codigo = '$codigoConta'";
                        ...
                        $sql = "UPDATE movimentoreceber SET  dataMovimento = '$dataMovimento', valor = '$valor', juros = '$juros', total = '$total'
                        ...
                        $sqlContareceber = "UPDATE contasreceber SET valor = valor - $total, parcela = parcela - '$parcela' WHERE codigo = '$codigoConta'";
                        ...
                        $sqlContacorrente = "UPDATE contascorrente SET saldoatual = saldoatual - $total WHERE codigo = '$codContaCorrente'";
                ...
                if (isset($_POST['excluir'])) {
                    ...
                    $sql_excluir = "DELETE FROM movimentoreceber WHERE idmovimento='$idmovimento'";
            ...
            <div class="modal-body">
                ...
                <form class="form-group well" action="movimentoReceber.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="codContaCorrente" id="codContaCorrente"   class="form-control" style=" margin-bottom: -2px; height: 25px;">
                                     <option value=0 selected="selected">Código conta corrente</option>
                                     <?php
                                     $sql_contascorrente = "SELECT codigo, descricao FROM contascorrente";
                                     $res_contascorrente = mysqli_query($con,$sql_contascorrente);
...
$(document).ready(function() {
    ...
    if ('<?php echo isset($_SESSION['redirected_from_contasreceber']) ? $_SESSION['redirected_from_contasreceber'] : '' ?>' == '1') {
        ...
        <?php unset($_SESSION['redirected_from_contasreceber']); ?>;
    }
});
</script>
